	...
	public boolean saveOrUpdate(Cat t) {
		...
		try {
			...
			if (sessionFactory != null) {
				...
				// save lưu khi đối tượng không bị trùng
				// saveOrUpdate lưu khi đối tượng không bị trùng nếu trùng thì cập nhật
				// Và cả 2 đều trả về Id khi lưu thành công và quăng ra ngoại lệ khi xảy ra lỗi
				// persist nó cũng lưu đối tượng như save nhưng không trả về Id khi lưu thành
				// công và cũng không quăng ngoại lệ khi xảy ra lỗi 
