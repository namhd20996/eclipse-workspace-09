...
<body>
						...
						<li class="nav-item dropdown dropstart"><a
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item"
									href="khachhang/information.jsp">Thay đổi thông tin</a></li>
								<li><a class="dropdown-item"
									href="khachhang/changepassword.jsp">Đổi mật khẩu</a></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item"
									href="khach-hang?action=dang-xuat">Thoát tài khoản</a></li>
							</ul></li>
					</ul>
					<%
					}
	...
	<div class="container">
		...
		<footer class="py-3 my-4">
			...
			<p class="text-center text-muted">© 2022 Nam.vn, Inc</p>
		</footer>
		<!-- End Footer -->
</body>
</html>