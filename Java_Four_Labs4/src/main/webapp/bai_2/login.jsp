...
<body>
	<main class="form-signin w-100 m-auto">
		<form class="text-center" action="<%=url%>/user-servler" method="POST">
			<input type="hidden" name="action" value="dang-nhap"> <img
				class="mb-4" src="<%=url%>/img/logo/Duynam%20(4).png" alt=""
				width="280px">
			...
			<div class="form-floating">
				<input type="text" class="form-control" id="tenDangNhap"
					placeholder="Tên đăng nhập" name="tenDangNhap" value="${form.userName }"> <label
			...
			<div class="checkbox mb-3">
				<label> <input type="checkbox" value="remember-me" ${form.remember?'checked':'' }>
	...
	<hr>
	<%
		//List[UserModel] list = request.getParameterValues(name);
	%>
<span class="container" style="width: 80%">
			<table class="table">
				<thead>
					<tr>
						<th scope="col">#</th>
