          ...
          <div class="card card-primary">
            ...
            <form id="formSubmit">
              <div  class="form-group">
                ...
                <input type="text" id="title" name="title" value="${video != null ? video.title : '' }" class="form-control">
              </div>
              <div class="form-group">
                <label for="href">Href</label>
                <input type="text" id="href" name="href" value="${video != null ? video.href : '' }" class="form-control">
              </div>
              <div class="form-group">
				<div class="row">
					<div class="col-9">
						<div class="row">
							<div class="col-12 form-group">
								...
								<textarea id="description" name="description" class="form-control" rows="4">${video != null ? video.description : '' }</textarea>
							</div>
							<div class="col-12 form-group">
								<label for="poster">Poster</label>
								<input type="text" id="poster" name="poster" value="${video != null ? video.poster : '' }" class="form-control">
							</div>
						</div>
					</div>
					<div class="col-3">
              ...
              <input type="hidden" name="id" value="${video.id}" id="newId"/>
		</form>
            </div>
            <!-- /.card-body -->
          </div>
...
<script type="text/javascript">
	var titleOrigin, hrefOrigin, posterOrigin, descriptionOrigin;
...
<script type="text/javascript"> -->
	$('#submitBtn').click(function(e){
        ...
        if(id == ""){
        	url = 'http://localhost:8080/Java_Four_Assign/admin/video?action=add';
        }else{
        	url = 'http://localhost:8080/Java_Four_Assign/admin/video?action=edit&hrefOrigin=' + hrefOrigin;
        }
        $.ajax({
        	url : url,
        	type : 'POST',
