...
public class Email {
	...
	public static String getNoiDung(UserEntity user) {
		String link = "http://localhost:8080/BoostrapLearning/khach-hang?action=xac-thuc&maKhachHang="
				+ user.getId() + "&maXacThuc=" + user.getVerify();
		String noiDung = "<p>Xin ch&agrave;o bạn: <strong>" + user.getFullname() + "</strong></p>\r\n"
