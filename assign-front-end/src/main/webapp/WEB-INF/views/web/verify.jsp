...
<c:url var='verifyURL' value='/login/verify' />
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form" id="formLogin">
					...
					<div class="wrap-input100 validate-input m-b-26">
						<span class="label-input100">Verify Code</span> <input
							class="input100" type="text" id="verify" name="verify"
							placeholder="Enter Verify"> <span class="focus-input100"></span>
					...
					<div class="flex-sb-m w-full p-b-30">
						...
						<div>
							<a href="<c:url value='/login/forgot'/>" class="txt1"> Forgot
								Password? </a>
						</div>
					</div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
          Validator({
            ...
            rules: [
				...
				Validator.isRequired('#verify', 'Vui lòng nhập verify'),
            ...
            onSubmit: function(data){
            	$.ajax({
            		...
            		success: function(result){
            			alert('Success')
            			window.location.href = 'http://localhost:8080/assign-front-end/login'
            		},
