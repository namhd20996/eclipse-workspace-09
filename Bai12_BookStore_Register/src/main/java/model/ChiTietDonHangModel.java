...
public class ChiTietDonHangModel {
	...
	public ChiTietDonHangModel(String maCTDH, DonHangModel donHang, SachModel maSach, int soLuong, double giaBia,
	...
	public String toString() {
		return "ChiTietDonHangModel [maCTDH=" + maCTDH + ", donHang=" + donHang + ", maSach=" + maSach + ", soLuong="
	...
	@Override
	public int hashCode() {
		return Objects.hash(donHang, giaBan, giaBia, giamGia, maCTDH, maSach, soLuong, thue, tongTien);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(donHang, other.donHang)
				...
				&& Objects.equals(maCTDH, other.maCTDH) && Objects.equals(maSach, other.maSach)
