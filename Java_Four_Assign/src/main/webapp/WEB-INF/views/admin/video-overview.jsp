...
<!-- DataTables -->
  <link rel="stylesheet" href="<c:url value='/templates/admin/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css'/>">
  <link rel="stylesheet" href="<c:url value='/templates/admin/plugins/datatables-responsive/css/responsive.bootstrap4.min.css'/>">
  <link rel="stylesheet" href="<c:url value='/templates/admin/plugins/datatables-buttons/css/buttons.bootstrap4.min.css'/>">
  <!-- Theme style -->
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="<c:url value='/templates/admin/dist/img/AdminLTELogo.png'/>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
						<img id="image-1" alt="" src="https://img.youtube.com/vi/${item.poster }/maxresdefault.jpg" width="150px" height="100px"/>
                    </td>
                    <td> 
                    	<a type="button" href="<c:url value='/admin/video?action=edit&href=${item.href }'/>" class="btn btn-block btn-success btn-sm">Edit</a>
...
<script type="text/javascript">
	function deleteVideo(href){
		$.ajax({
			url : 'http://localhost:8080/Java_Four_Assign/admin/video?action=delete&href=' + href,
			type: 'GET',
			contentType: 'application/json'
		}).then(function(data){
			window.location.href = 'http://localhost:8080/Java_Four_Assign/admin/video?action=view';
		}).fail(function(){
			alert('Oop!!!');
		})
	}
