...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<c:url value='/trang-chu'/>" class="nav-link">Comeback index</a>
        </li>
      </ul>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable with Online Entertaiment</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               <div class="form-group">
					<label id="label-1">List Video</label>
...
<script>
  ...
  $('#selectVideo').change(function(){
  	...
  	$.ajax({
  		url : 'http://localhost:8080/Java_Four_Assign/admin/favorites?href=' + videoHref,
  		type : 'GET',
