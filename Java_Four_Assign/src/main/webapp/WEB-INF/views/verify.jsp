...
<body>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<c:url value='/register'/>" method="post">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" id="verify" type="text" name="verify" placeholder="Enter verify">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						<button id="verifyBtn" type="button" class="login100-form-btn">
							Verify
						</button>
					</div>
				</form>
	...
	<script type="text/javascript">
		$('#verifyBtn').click(function(e){
			...
			$.ajax({
				url : 'http://localhost:8080/Java_Four_Assign/login/verify',
				type : 'POST',
				data : formData
			}).then(function(data){
				window.location.href = 'http://localhost:8080/Java_Four_Assign/login';
			}).fail(function(error){
				alert('Oop!!');
			})
		})
