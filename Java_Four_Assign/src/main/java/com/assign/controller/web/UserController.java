...
@WebServlet(value = { "/login", "/logout", "/login/register", "/login/forgot", "/login/verify",
		"/login/change-pass" }, name = "ofUser")
public class UserController extends HttpServlet {
	...
	private void doPostChangePass(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
